...
ONEPRIOR(pli,-4,0,log)
ONEPRIOR(kmii,2.41,2.718,flat)
ONEPRIOR(hf1i,-3,3,log)
ONEPRIOR(li,-3,3,log)
ONEPRIOR(rpi1,1,1.5,flat)
ONEPRIOR(dwi,0.9,2,log)
ONEPRIOR(mhi,-2,2,log)
ONEPRIOR(rgi,-4,4,log)
ONEPRIOR(mssmi,-2,2,log)
...
TWOPRIORS(bsusybi,-5,-1,log,-100,0,flat)
...
TWOPRIORS(cwi,10.873,10.873,flat,-10,-1,log)
...
TWOPRIORS(bei,-3,3,log,-1.5,2.5,log)
...
THREEPRIORS(lpi1,1,5,flat,1,5,flat,-3,3,log)
THREEPRIORS(lpi2,1,5,flat,1,5,flat,-3,-3,log)
THREEPRIORS(lpi3,1,5,flat,1,5,flat,-3,-3,log)
